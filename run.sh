...
CUDA_VISIBLE_DEVICES=1   python base_test.py --netG=base3 --gpu_ids=0  --name base3_grid_1 --dataname=grid --dataroot /home/cxu-serve/p1/common/grid  --batchSize 36   --nThreads 1 --num_frames=1
