...
CUDA_VISIBLE_DEVICES=7,6,4   python base_train.py --gpu_ids=0,1,2  --netG=base2 --name base2_lrs --dataname=lrs --batchSize 128 --niter 10000  --dataroot  /mnt/Data02/lchen63/lrs/   --batchSize 8 --niter 10000   --n_layers_D=3  --num_D=2 --lr=0.00005 --num_frames=1
