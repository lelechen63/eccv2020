...
CUDA_VISIBLE_DEVICES=3   python base_train.py --model=base1 --gpu_ids=0 --netG=base1  --name base1_vox_1 --dataname=vox --dataroot /home/cxu-serve/p1/common/voxceleb2  --batchSize 16 --niter 10000  --nThreads 1 --n_layers_D=3  --num_D=2 --lr=0.00005 --num_frames=1 --debug
