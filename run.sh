...
CUDA_VISIBLE_DEVICES=0,1,2,3   python train_new.py --model=base1 --gpu_ids=0,1,2,3 --netG=base5  --name base5_vox_8 --dataname=vox --dataroot /home/cxu-serve/p1/common/voxceleb2  --batchSize 24  --niter 10000  --nThreads 24 --n_layers_D=3  --num_D=2 --lr=0.0002 --num_frames=8 #--debug
